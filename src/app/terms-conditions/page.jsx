      ...
      <div className="max-w-4xl p-8 mx-auto bg-white border shadow-sm md:p-12 rounded-2xl border-slate-100">
        ...
        <div className="space-y-6 leading-relaxed text-slate-600">
          <p>
            ...
            "our" used anywhere on this page shall mean BLUE DATA CONSULTING AND
            IT SERVICES PRIVATE LIMITED, whose registered/operational office is
            706, INTERNATIONAL FINANCE CENTER, VIP ROAD, VESU, SURAT GUJARAT 395007. "you", "your", "user",
          ...
          <ul className="pl-6 space-y-3 list-disc">
            ...
            <li>
              ...
              document without BLUE DATA CONSULTING AND IT SERVICES PRIVATE
