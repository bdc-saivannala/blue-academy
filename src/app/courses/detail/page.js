      ...
      <div className="grid grid-cols-1 gap-12 px-6 py-12 mx-auto max-w-7xl lg:grid-cols-12">
        ...
        <div className="space-y-16 lg:col-span-8">
          ...
          <section className="p-8 border border-blue-100 bg-blue-50 rounded-2xl">
            ...
            <div className="pt-4 border-t border-blue-200">
              <p className="text-xl font-bold text-slate-900">Prerequisites:</p>
          ...
          {/* --- NEW SECTION: TESTIMONIALS (Missing Topic Added Here) --- */}
              ...
              {[
                {
                  ...
                  text: "The capstone projects were a game changer. I used my project on 'Customer Churn' to crack my interview.",
                  image:
                ...
                },
                {
                  ...
                  text: "Blue Academy's curriculum is exactly what the industry needs. The transition from theory to deployment was seamless.",
                  image:
                ...
                <div
                  key={i}
                  className="relative p-6 bg-white border shadow-sm border-slate-100 rounded-xl"
                >
                  <Quote className="absolute w-8 h-8 text-blue-100 top-4 right-4" />
          ...
          <section
            ...
            className="flex items-start gap-6 p-8 bg-white border shadow-sm rounded-2xl border-slate-200"
          >
            <div className="flex-shrink-0 hidden w-32 h-32 border rounded-lg md:block bg-slate-100 border-slate-200">
              {/* Use an actual cert image here if available */}
              <img
          ...
          {/* ID: Careers (Upgraded to "Job Display" style) */}
          {/* <section id="careers">
            <h2 className="mb-6 text-2xl font-bold text-slate-900">
              Career Opportunities
            </h2>
            ...
            <div className="grid grid-cols-1 gap-4 mb-8 md:grid-cols-2">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center justify-between p-4 bg-white border rounded-lg shadow-sm border-slate-200"
                >
                  <div>
            ...
            <div className="flex gap-8 transition-all opacity-50 grayscale hover:grayscale-0">
              <span className="text-xl font-bold">Google</span>
              <span className="text-xl font-bold">Amazon</span>
              <span className="text-xl font-bold">Uber</span>
              <span className="text-xl font-bold">Microsoft</span>
          ...
          <section id="careers">
            ...
            <div className="grid grid-cols-1 gap-4 mb-8 md:grid-cols-2">
              {[
                ...
                // Create a dynamic search URL (Naukri Pattern)
                // Example: "AI Engineer" -> "ai-engineer-jobs"
                const searchUrl = `https://www.naukri.com/${job.role
                  .toLowerCase()
                  .replace(/\s+/g, "-")}-jobs`;
                ...
                return (
                  <a
                    ...
                    className="flex items-center justify-between p-4 transition-all bg-white border rounded-lg shadow-sm cursor-pointer border-slate-200 hover:border-blue-600 hover:shadow-md group"
                    title={`Find ${job.role} jobs on Naukri`}
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <p className="font-bold transition-colors text-slate-900 group-hover:text-blue-600">
                          {job.role}
                        </p>
                        {/* Optional: Small icon to show it's a link */}
                        <svg
                          ...
                          className="transition-opacity opacity-0 text-slate-400 group-hover:opacity-100"
                        >
