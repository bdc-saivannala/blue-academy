...
const ScheduleCallButton = () => {
  return (
    <a
      href="https://outlook.office.com/bookwithme/user/74bcd3456aa44cdd96054ef88ae4c4f7@bluedataconsulting.in?anonymous&ismsaljsauthenabled&ep=plink" // REPLACE THIS
      target="_blank"
      rel="noopener noreferrer"
      // Change: Added overflow-hidden and adjusted padding/width logic
      className="fixed z-50 flex items-center justify-center p-4 font-bold text-white transition-all duration-300 ease-in-out transform rounded-full shadow-2xl bottom-24 right-6 bg-gradient-to-r from-blue-600 to-indigo-600 group hover:pr-6 hover:w-auto w-14 hover:gap-3"
    >
      {/* Icon Box */}
